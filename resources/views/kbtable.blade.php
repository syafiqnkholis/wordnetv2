...
<div class="row kblayout">
    ...
    <div class="col-md-8 ">
        <div class="row">
            <h4 class="col-md-3" style="color: #fff;">TABEL KATA BENDA</h4>
            <a href="/kbbaru" type="button" class="btn btn-success mt-2 col-md-2" style="width: 80px; color:#fff">Buat baru</a>
        </div>
        <!-- susunan hipernim ================================================ -->
    ...
    var table = $('#myTable').DataTable({
        ...
        "fnCreatedRow": function(nRow, aData, iDataIndex) {
            $('td:eq(3)', nRow).append(
                ...
                "<a class='btn btn-default' href='/kbedit/" + aData['id_kb'] + "'><i class='fas fa-cog'></i></a>" +
