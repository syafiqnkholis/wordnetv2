...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
    <div class="row bg" id="bg-wrapper">
    <div class="col-md-3 wrapper">
            <div class="mt-1">
                <button class="btn setting" style="float: left; margin-left:100px;color: #fff;">
                <i class="fas fa-chevron-circle-down fa- mt-1 mr-1 mb-1" style="color: #fff;" ></i>
                Jarak kata
                </button>
            </div><br>
        ...
        <div class="col-md-6 wrapper">
            <div class="row">
                <div class="col-md-12 mt-4" >
                    ...
                    <p class="ml-3 desc" style="color:#fff; font-size:13px; width:90%; text-align:justify">WordNet® UGM merupakan sistem WordNet berbahasa Indonesia yang dikembangkan oleh dosen dan mahasiswa UGM. WordNet ini dibangun dengan maksud untuk membantu pengguna dalam menemukan makna suatu kata, relasi antar kata, dan kedalaman antar kata. Yang difokuskan dalam WordNet ini yakni penggunaan hipernim dan hiponim kata. Sehingga diharapkan sistem ini dapat membantu pengguna dalam membantu memberikan informasi dan tolak ukur dalam kegiatan penulisan berbahasa Indonesia.</p>
                    <div class="mt-4">
                    <input type="text" id="inputquery" class="form-control mr-1 input" placeholder="&#xF002; cari" >
                    </div>
                </div>
                <div class="container mt-2 ml-1" style="font-size: 15px;">
                    <h6>CPU</h6>
